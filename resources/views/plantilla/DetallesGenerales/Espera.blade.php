	...
	<div class="toolbar" id="kt_toolbar">
		...
		<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
			...
			<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
				<!--begin::Title-->
				<h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Mantenimiento en Espera</h1>
				<!--end::Title-->
				<!--begin::Separator-->
				<!--end::Separator-->
							...
							<div class="card-header align-items-center py-5 gap-2 gap-md-5">
								...
								<div class="card-toolbar flex-row-fluid justify-content-end gap-5">
									...
									<div class="position-relative d-flex align-items-center">
										...
										<!--end::Icon-->
										<!--begin::Datepicker-->
										{{-- <input type="date" class="form-control form-control-solid ps-12" placeholder="Filtrar por rango de fechas" name="rangoFechaDetallEspera" id="rangoFechaDetallEspera"    /> --}}
										<!--end::Datepicker-->
									</div><!--begin::Export dropdown-->
										...
										<tr class="text-start text-gray-500 fw-bold fs-7">
											...
											@can('detallesGen.delete')
														...
														<div class="menu-item px-3">
															...
															<a href="{{url('/eliminar/detallegen'.$itemEspera->id) }}" class="menu-link px-3 delete-link"
											...
											<div class="modal fade" id="modalMostrarImagen aria-hidden="true">
												<!--begin::Modal dialog-->
													...
													<div class="modal-dialog modal-lg">
														<div class="modal-content">
															...
															<div class="modal-body">
																<form action="{{route('edit.espera',$itemEspera->id)}}" id="formdetallesModificarEsperaa" method="POST" enctype="multipart/form-data">
																	@csrf
