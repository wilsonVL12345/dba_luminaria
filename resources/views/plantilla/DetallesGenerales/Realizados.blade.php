	...
	<div class="toolbar" id="kt_toolbar">
		...
		<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
			...
			<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
				<!--begin::Title-->
				<h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Mantenimientos Realizados</h1>
				<!--end::Title-->
				<!--begin::Separator-->
							...
							<div class="card-header align-items-center py-5 gap-2 gap-md-5">
								...
								<div class="card-toolbar flex-row-fluid justify-content-end gap-5">
									...
									<div class="position-relative d-flex align-items-center">
										...
										<!--end::Icon-->
										<!--begin::Datepicker-->
										{{-- <input type="date" class="form-control form-control-solid ps-12" placeholder="Filtrar por rango de fechas" name="rangoFechaDetallRealizado" id="rangoFechaDetallRealizado"    /> --}}
										<!--end::Datepicker-->
								...
								<table class="table align-middle border rounded table-row-dashed fs-6 g-5" id="detalleRealizado">
									<thead>
										...
										<tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase">
											...
											<th class="min-w-200px" >Urbanizacion</th>
											<th class="min-w-150px">Nro Sisco</th>
											<th class="min-w-150px" style="min-width: 150px;">Tipo de Trabajo</th>
											<th class="min-w-80px">Puntos</th>
											<th class="min-w-150px">Fecha de Atencion</th>
											<th class="min-w-70px">Carta</th>
									...
									<tbody class="text-gray-600">
										...
										<tr class="text-start text-gray-500 fw-bold fs-7">
											...
											<td>
												<a href="" class="text-gray-600 text-hover-primary mb-1"><i class="fa-regular fa-eye"></i>
