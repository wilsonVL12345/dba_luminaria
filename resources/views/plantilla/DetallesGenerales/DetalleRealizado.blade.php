                            ...
                            <form action="{{route('registro.almacen')}}" id="formproyecto" method="POST" >
								...
								<div class="from row">
									<div class="col-md-3 mb-3">
										...
										<input type="text" class="form-control form-control-solid " id="txtcod" name="txtcod" value="{{$trabajo->Nro_Sisco}}"  readonly>
									</div>
									<div class="col-md-3 mb-3">
										<label for="txtdistrito" class=" fs-5 fw-bold mb-2">Distrito</label>
										<input type="text" class="form-control form-control-solid " id="txtdistrito" name="txtdistrito" value="{{$trabajo->distrito->Distrito}}" readonly>
									</div>
									<div class="col-md-6 mb-3">
										<label for="txturbanizacion" class=" fs-5 fw-bold mb-2">Urbanizacion</label>
										<input type="text" class="form-control form-control-solid " id="txturbanizacion" name="txturbanizacion" value="{{$trabajo->Zona}}" readonly>
									</div>
								</div>
								<div class="from row">
									<div class="col-md-6 mb-3">
										<label for="txtcomponentes" class=" fs-5 fw-bold mb-2">Tipo de trabajo</label>
										<input type="text" class="form-control form-control-solid " id="txtcomponentess" name="txtcomponentes" value="{{$trabajo->Tipo_Trabajo}}" readonly>
									</div>
									<div class="col-md-3 mb-3">
										<label for="txtcontratacion" class=" fs-5 fw-bold mb-2">Puntos</label>
										<input type="text" class="form-control form-control-solid " id="txtcontratacion" name="txtcontratacion" value="{{$trabajo->Puntos}}" readonly>
									</div>
									<div class="col-md-3 mb-3">
                                        <label class="required fs-6 fw-bold mb-2">Fecha de Atencion</label>
                                        <!--begin::Input-->
                                        <div class="position-relative d-flex align-items-center">
                                            ...
                                            <!--end::Icon-->
                                            <!--begin::Datepicker-->
                                            <input type="date" class="form-control form-control-solid ps-12" placeholder="Select a date" name="txtfecha" id="txtfecha" value="{{$trabajo->Fecha_Inicio}}" readonly />
                                            <!--end::Datepicker-->
                                        </div>
                                        <!--end::Input-->
                                </div>
								...
								<div class="from row">
									...
									<div class="col-md-6 mb-3">
										<label for="txtmodalidad" class=" fs-5 fw-bold mb-2">Observaciones</label>
										<input type="text" class="form-control form-control-solid " id="txtmodalidad" name="txtmodalidad" value="{{$trabajo->Observaciones}}"  readonly>
									</div>
                                    @else
                                    <div class="col-md-6 mb-3">
										<label for="txtmodalidad" class=" fs-5 fw-bold mb-2">Observaciones</label>
										<input type="text" class="form-control form-control-solid " id="txtmodalidad" name="txtmodalidad" value="Ninguno"  readonly>
									</div>
                                    @endif
							...
							<div class="table-responsive">
								<table class="table table-bordered" >
									...
									<tbody>
										...
										<tr>
											<td><?php echo $num; ?></td>
											<td>{{$item->lista_accesorio->Nombre_Item}}</td>
                                            <td>{{$item->Cantidad}}</td>
