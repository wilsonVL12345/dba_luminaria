								...
								<!--end::Close-->
									...
									<div class="modal-footer flex-center">
										<div class="text-center">
											{{-- <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">CerrarR</button> --}}
										...
										<div class="modalmodificar">
											<div class="modal fade" id="modalModificar{{$itememp->id}}" tabindex="-1" aria-hidden="true">
												...
												<div class="modal-dialog modal-dialog-centered mw-650px">
													...
													<div class="modal-content">
														<!--begin::Form-->
														<form class="form" action="{{route("editar.equipamiento")}}" id="kt_modal_add_customer_form" data-kt-redirect="assets/dist/apps/customers/list.html" method="POST" >
															@csrf
															<!--begin::Modal header-->
															<div class="modal-header" id="kt_modal_add_customer_header">
																<!--begin::Modal title-->
