									...
									<table class="table align-middle border rounded table-row-dashed fs-6 g-5" id="inspeccionrealizado">
										...
										<tbody class="fw-semibold text-gray-600">
											...
											@can('inspecciones.edit')
												...
												<div class="modal fade" id="modalModificarInspeccionRea" tabindex="-1" aria-hidden="true">
													<!--begin::Modal dialog-->
													<div class="modal-dialog modal-dialog-centered mw-650px">
														<!--begin::Modal content-->
														<div class="modal-content rounded">
															...
															<div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
																<!--begin:Form-->
																<form id="formInspeccionModificarRealizado" class="form" action="{{route('inspecciones.editrealizadas')}}" method="POST" enctype="multipart/form-data">
																	@csrf
																	<!--begin::Heading-->
																	<div class="mb-13 text-center">
																		<!--begin::Title-->
																	...
																	<!--begin::Input group-->
																		...
																		<div class="row">
																			<input type="text" name="textid" id="textid" style="display: none;"  />
																		  <div class="col-md-4">
																			<label for="" class="required d-flex align-items-center fs-6 fw-bold mb-2">Nro Sisco
																				<i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip"  title="Solo se permiten números y - en este formato ejem 252353-2024  "></i>

																			</label>
																			<input type="text" class="form-control form-control-solid" placeholder="Ingrese Numero Sisco" name="txtsisco" id="txtsisco" pattern="^[0-9]{5,6}-[0-9]{4}$"  required/>
																		  ...
																		  <div class="col-md-4">
																			...
																			<div class="position-relative d-flex align-items-center">
																				...
																				<!--end::Icon-->
																				<!--begin::Datepicker-->
																				<input id="daterealiModificar"  class="form-control form-control-solid ps-12"  name="txtfecha"   required/>
																				<!--end::Datepicker-->
																			</div>
																			<!--end::Input-->
																		</div>
																	...
																	<div class="d-flex flex-column mb-8 fv-row">
																		...
																		<select  aria-label="Select a Country"
																			...
																			data-control="select2"
																			data-dropdown-parent="#modalModificarInspeccionRea"
																			class="form-control form-select-solid "  name="slurbInspRea" data-id="slurbInspRea" required>
																			<option value="" >Seleccione...</option>
																			</select>
																	</div>
																	<!--end::Input group-->
																	...
																	<div class="row g-9 mb-8">
																		...
																		<div class="col-md-6 fv-row">
																			<label class="required fs-6 fw-bold mb-2">Tipo de Inspeccion</label>
																			<select class="form-control form-select-solid" data-control="select2" data-hide-search="true" data-placeholder="Selecione..." name="txttipo" id="txttipo">
																				<option value="" >Seleccione...</option>
																		...
																		<div class="col-md-6 fv-row">
																			<label class="required fs-6 fw-bold mb-2">Estado</label>
																			<select class="form-control form-select-solid" data-control="select2" data-hide-search="true" data-placeholder="Selecione..." name="txtestado" id="txtestado">
												...
												@endcan
												<!--begin::Modal -imagen carta-->
												<div class="modal fade" id="modalMostrarImagenr" tabindex="-1" aria-hidden="true">
