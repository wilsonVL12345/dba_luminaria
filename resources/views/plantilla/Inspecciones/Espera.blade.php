	...
	<div class="toolbar" id="kt_toolbar">
		...
		<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
			...
			<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
				<!--begin::Title-->
				<h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Inspecciones en Espera</h1>
				<!--end::Title-->
				<!--begin::Separator-->
					...
					<div class="margin">
						...
						<div class="card card-p-0 card-flush">
							...
							<div class="card-body">
								<table class="table align-middle border rounded table-row-dashed fs-6 g-5" id="tablainspeccions">
									<thead>
										...
										<tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase">
											<th class="min-w-125px">Nro Sisco</th>
												...
												<th class="min-w-125px">Fecha Ingreso</th>
									...
									<tbody class="fw-semibold text-gray-600">
										...
										<tr class="text-start text-gray-500 fw-bold fs-7">
											...
											<!--end::Menu item-->
												<!--begin::Modal -modal para  mostrar la carta de cada  inspeccion-->
								...
								@can('inspecciones.edit')
								<!--begin::Modal - Modal para  modificar inspecciones en espera-->
								<div class="modal fade" id="modalModificarInspeccion" tabindex="-1" aria-hidden="true">
									<!--begin::Modal dialog-->
									<div class="modal-dialog modal-dialog-centered mw-650px">
										<!--begin::Modal content-->
										<div class="modal-content rounded">
											...
											<div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
												...
												<form id="formInspeccionEsperaModificar" class="form" action="{{route('editar.inspeccionespera')}}" method="POST" enctype="multipart/form-data">
													...
													<!--begin::Input group-->
													<div>
														<input type="text" id="txtid" name="txtid" style="display: none;" value="" readonly> 
													</div>
													<div class="d-flex flex-column mb-8 fv-row">
														<!--begin::Label-->
														<label class="d-flex align-items-center fs-6 fw-bold mb-2">
														...
														<!--end::Label-->
														<input type="text" class="form-control form-control-solid"  name="txtsisco" id="txtsiscoEspeM" pattern="^[0-9]{5,6}-[0-9]{4}$"  required/>
													</div>
													<!--end::Input group-->
													<!--begin::Input group-->
													<div class="row g-9 mb-8">
														...
														<div class="col-md-3 fv-row">
															...
															<select class="form-select form-select-solid" data-control="select2"  data-placeholder="Selecione..." name="sldistInspEsp" data-id="sldistInspEsp" required >
																<option value="" >Seleccione...</option>
																@foreach ($listadistrito as $items)
																<option value="{{$items->id}}" >{{$items->Distrito}}</option>
																@endforeach
																</select>
														</div>
														...
														<div class="col-md-9 fv-row">
															...
															data-control="select2"
															{{-- data-placeholder="{{$item->Zona}}" --}}
															data-dropdown-parent="#modalModificarInspeccion"
															class="form-control form-select-solid fw-bolder" name="slurbInspEsp" data-id="slurbInspEsp" required>
													...
													<div class="row g-9 mb-8">
														...
														<div class="col-md-6 fv-row">
															...
															<div class="position-relative d-flex align-items-center">
																...
																<!--end::Icon-->
																<!--begin::Datepicker-->
																<input id="txtfechainpec"  type="date" class="form-control form-control-solid ps-12" placeholder="Seleccionar Fecha" name="txtfecha"    required/>
																<!--end::Datepicker-->
															</div>
															<!--end::Input-->
														</div>
								...
								<!--begin::Modal -Empezar inspeccion-->
								@can('inspecciones.install')
								<div class="modal fade" id="modalEmpezarInspeccion" tabindex="-1" aria-hidden="true">
									<!--begin::Modal dialog-->
									<div class="modal-dialog modal-dialog-centered mw-650px">
										<!--begin::Modal content-->
										<div class="modal-content rounded">
											...
											<div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
												...
												<form id="formEmpezarInspeccion" class="form" action="{{route('empezar.inspeccionespera')}}" method="POST">
													...
													<div class="row g-9 mb-8">
														<!--begin::Col-->
														<input type="text" id="txtid" name="txtid" style="display: none;" readonly>
														<div class="col-md-6 fv-row">
															<!--begin::Label-->
															<label class="d-flex align-items-center fs-6 fw-bold mb-2">
																<span class="required">Nro Sisco</span>
															...
															<!--end::Label-->
															<input type="text" class="form-control form-control-solid" placeholder="Ingrese Numero Sisco" name="txtsisco" pattern="^[0-9]{5,6}-[0-9]{4}$"  readonly />
														</div>
														<!--end::Col-->
														<!--begin::Col-->
														<div class="col-md-6 fv-row">
															...
															<!--end::Label-->
															<input type="text" class="form-control form-control-solid" placeholder="Ingrese Numero Sisco" name="txtdistrito"  readonly/>
														</div>
														<!--end::Col-->
													</div>
													<div class="row g-9 mb-8">
														...
														<!--end::Label-->
														<input type="text" class="form-control form-control-solid" placeholder="Ingrese Numero Sisco" name="txtzurb"   readonly/>
												...
												<div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
													...
													<form id="formInspeccionEsperaRegistrar" class="form" action="{{route('registro.inspecciones')}}" method="POST" enctype="multipart/form-data">
														...
														<div class="d-flex flex-column mb-8 fv-row">
															...
															<!--end::Label-->
															<input type="text" class="form-control form-control-solid" placeholder="Ingrese Numero Sisco" name="txtnrosisco" pattern="^[0-9]{5,6}-[0-9]{4}$" required />
														</div>
														<!--end::Input group-->
														<!--begin::Input group-->
														<div class="row g-9 mb-8">
