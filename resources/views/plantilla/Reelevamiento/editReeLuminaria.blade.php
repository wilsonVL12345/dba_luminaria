                                                    ...
                                                    <form class="form" action="{{route('reelevamiento.modificar',$reele->id)}}" id="reelevamientoCreate" data-kt-redirect="assets/dist/apps/customers/list.html" enctype="multipart/form-data" method="POST" >
                                                            ...
                                                            <div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_customer_header" data-kt-scroll-wrappers="#kt_modal_add_customer_scroll" data-kt-scroll-offset="300px">
                                                                ...
                                                                <div class="row g-6 mb-4">
                                                                     ...
                                                                     <div class="col-md-3 fv-row">
                                                                        ...
                                                                        <select class="form-control form-select-solid" data-control="select2" data-search="false"  data-hide-search="true" data-placeholder="Selecione..." name="reeDistritoRegisMod" data-id="reeDistritoRegisMod"
                                                                          required >
                                                        ...
                                                        <div class="modal-footer flex-center">
                                                            <div class="text-center">
                                                                <a href="/reelevamientos/dis/{{$reele->Distritos_id}}" type="button" i class="btn btn-danger me-3">Cerrar</a>
