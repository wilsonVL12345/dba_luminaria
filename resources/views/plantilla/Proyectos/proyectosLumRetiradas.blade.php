	...
	<div class="toolbar" id="kt_toolbar">
		<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
			<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
				<h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Informacion de todas las Luminarias Retiradas</h1>
														...
														<div class="modal fade" id="modalModificarLumRetiradas{{$item->id}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
															...
															<div class="modal-dialog mw-1000px">
																...
																<div class="modal-content">
																	...
																	<div class="modal-header">
																		<!--begin::Title-->
																		<h2>Modificar Datos Generales de Luminarias Retiradas</h2>
																		<!--end::Title-->
																		<!--begin::Close-->
																		<div class="btn btn-sm btn-icon btn-active-color-primary" data-bs-dismiss="modal">
																			<!--begin::Svg Icon | path: icons/duotune/arrows/arr061.svg-->
																				...
																				<form class="form" action="{{route('modificar.retirados',$item->id)}}" id="form1" method="POST">
																						...
																						<div class="modal-body py-10 px-lg-17">
																								<div class="from row">
																											...
																											<div class="col-md-3 mb-3">
																												<label for="txtdistritoMod" class="required fs-5 fw-bold mb-2">Distrito</label>
																												<select type="text" data-id="txtdistritoMod" name="txtdistritoMod" class="form-control form-select-solid" data-control="select2" data-hide-search="true" data-placeholder="Selecione..." required>
																													<option value="" disabled selected >Seleccione</option>
																														@foreach ($listadistritos as $dis)
																								...
																								<div class="from row">
																									...
																									<div class="col-md-4 mb-3">
																										...
																										<div class="position-relative d-flex align-items-center">
																											...
																											<!--end::Icon-->
																											<!--begin::Datepicker-->
																											<input type="date" class="form-control form-control-solid ps-12" placeholder="Select a date" name="txtfechamanteMod" id="txtfechamanteMod" value="{{$item->Fecha}}" required />
																											<!--end::Datepicker-->
																										</div>
																										<!--end::Input-->
																									</div>
