	...
	<div class="toolbar" id="kt_toolbar">
		<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
			<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
				<h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Proyectos</h1>
				...
				<div class="card-body pt-9 pb-0">
					<div class="card-body pt-9 pb-0">
						<div class="margin">
																...
																<div class="scroll-y me-n7 pe-7" id="modadRegistraUsuarios_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#modadRegistraUsuarios_header" data-kt-scroll-wrappers="#modadRegistraUsuarios_scroll" data-kt-scroll-offset="300px">
																	...
																	<div class="from row">
																		<div class="col-md-4 mb-3">
																			...
																			<input type="text" class="form-control form-control-solid " id="txtcod" name="txtcod" pattern="^[a-zA-Z0-9\/\-]{6,16}$" placeholder="Ingresar Datos" required >
																		</div>
							...
							<h1>Proyectos Pendientes Almacen</h1>
														...
														{{-- <form action="{{route('modificar.almacen',$item->id)}}" id="formproyectoModificar" method="POST" >
															...
															<div class="from row">
																<div class="col-md-3 mb-3">
																	...
																	<input type="text" class="form-control form-control-solid " id="txtcodProyEsp" name="txtcodProyEsp" pattern="^[a-zA-Z0-9\/\-]{6,16}$" value="{{$item->Cuce_Cod}}" required>
																</div>
																<div class="col-md-2 mb-1">
