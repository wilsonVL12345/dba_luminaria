                                ...
                                <div class="from row">
                                    ...
                                    <div class="col-md-3 mb-2">
                                        ...
                                        <div class="position-relative d-flex align-items-center">
                                            ...
                                            <!--end::Icon-->
                                            <!--begin::Datepicker-->
                                            <input type="date" class="form-control form-control-solid ps-12" placeholder="Select a date" name="txtfechaEsp" id="txtfechaEsp" value="{{$proyec->Fecha_Programada}}" required />
                                            <!--end::Datepicker-->
                                        </div>
                                        <!--end::Input-->
                                    </div>
