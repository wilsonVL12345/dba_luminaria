														...
														<form action="{{route('modificar.ObrasEjecuatas',$items->id)}}" id="formObrasEjecutadas" method="POST" >
															...
															<div class="from row">
																<div class="col-md-3 mb-3">
																	...
																	<input type="text" class="form-control form-control-solid " id="txtcodProyObras" name="txtcodProyObras" pattern="^[a-zA-Z0-9\/\-]{6,16}$" value="{{$items->Cuce_Cod}}" required>
																</div>
																...
																<div class="col-md-2 mb-1">
																	<label for="sltrabajoobras" class=" fs-5 fw-bold mb-2">Trabajo</label>
																	<select class="form-control form-select-solid" data-control="select2" name="sltrabajoobras" data-id="sltrabajoobras" required>
																		<option value="Central">Central</option>
																		@foreach ($listadistrito as $dis)
																		<option value="{{$dis->Distrito}}" {{$items->Distritos_id==$dis->id ? 'selected':''}}>{{$dis->Distrito}}</option>
																		@endforeach
																	</select>
																</div>
															...
															<div class="from row">
																...
																<div class="col-md-3 mb-3">
																	<label for="slejecut" class=" fs-5 fw-bold mb-2">Ejecutado Por</label>
