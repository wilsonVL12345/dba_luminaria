...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
	<!--begin::Head-->
	<head><base href="../../../">
		<title>Direccion de Luminaria Publica</title>
		<meta charset="utf-8" />
	...
	<body id="kt_body" class="bg-body">
		<!--begin::Main-->
		<!--begin::Root-->
		<div  class="d-flex flex-column flex-root" style="background-color: #1A243E">
			<!--begin::Authentication - Sign-in -->
			<div  
			 class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed" style="background-image: url(assets/media/illustrations/sketchy-1/14.png">
				<!--begin::Content-->
				...
				<div class="d-flex flex-center flex-column-auto p-10">
					...
					<div class="d-flex align-items-center fw-bold fs-6">
						<a href="#" class="text-muted text-hover-primary px-2">Dev</a>
						<a href="#" class="text-muted text-hover-primary px-2">Wilson</a>
						<a href="#" class="text-muted text-hover-primary px-2">V.L.</a>
					</div>
					<!--end::Links-->
				</div>
				<!--end::Footer-->
