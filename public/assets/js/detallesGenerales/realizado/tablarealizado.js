...
// Class definition
let detallesRealizados = function () {
    // Shared variables
    let tableDist;
    let datatable;
 ...
 */
                ...
                let detallesRealizados = function () {
                            ...
                            columns: [
                                ...
                                { data: "Fecha_Inicio", name: "Fecha_Inicio" },
                                {
                                    ...
                                    render: function(data, type, row) {
                                        if (data && data.trim() !== '') {
                                            return '<a href="#" class="btn btn-sm btn-icon btn-light view-imageRealizado" data-bs-toggle="modal" data-bs-target="#modalMostrarImagen" data-image-url="' + data + '"><i class="fas fa-image text-primary"></i></a>';
                                        } else {
                                            return '';
                ...
                
                                {
                                    ...
                                    name: "id",
                                    render: function(data, type, row) {
                                        return '<a href="/detalle/realizados/informacion/'+data+ '" class="text-gray-600 text-hover-primary mb-1"><i class="fa-regular fa-eye"></i></a>';
                                    }
                                },
                                {
                                    data: "action",
                    ...
                    // Hook export buttons
                    let exportButtons = () => {
                        const documentTitle = 'Lista de Trabajos Realizados';
                        let buttons = new $.fn.dataTable.Buttons(tableDist, {
                            buttons: [
                                {
                                    extend: 'copyHtml5',
                ...
                $(document).on('click', '.view-imageRealizado', function() {
