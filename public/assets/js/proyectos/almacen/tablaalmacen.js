...
// Class definition
let KTDatatablesExample2 = function () {
    // Shared letiables
    let table;
    let datatable;
    ...
    // Hook export buttons
    let exportButtons = () => {
        const documentTitle = 'Lista Almacen';
    ...
    return {
        init: function () {
            table = document.querySelector('#tablaAlmacen');
...
let tablafinalizado = function () {
    ...
    // Hook export buttons
    let exportButtons = () => {
        const documentTitle = 'Reposte Proyectos Ejecutados';
        let buttons = new $.fn.dataTable.Buttons(table, {
            buttons: [
                 {
                        extend: 'copyHtml5',
    ...
    return {
        init: function () {
            table = document.querySelector('#tablaEjecutado');
...
/* let tablaLumRetirada = function () {
    ...
    // Hook export buttons
    let exportButtons = () => {
        const documentTitle = 'Lista luminarias Retiradas';
        let buttons = new $.fn.dataTable.Buttons(table, {
            buttons: [
                 {
                        extend: 'copyHtml5',
    ...
    return {
        init: function () {
            table = document.querySelector('#tablaLumRetirada');
